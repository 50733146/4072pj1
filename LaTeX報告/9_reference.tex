...
\label{OGD2}
\bibitem 5\href{https://reurl.cc/gz0YjN}{https://zh.wikipedia.org/wiki/HSLHSL和HSV色彩空間}
\label{RGBtoHSV}
...
\bibitem 7\href{https://reurl.cc/xEQ3Ge}{https://github.com/schinger/pong\_ actor-critic/blob/master/pg-pong-ac.py}\label{R.pong1.1}
