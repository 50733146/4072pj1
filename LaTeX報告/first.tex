...
\qquad 將原本Y軸移動機構移除,並將其改為固定在特定位置上，此固定座設計是取代原本鎖在光軸固定坐上的(圖4.1 代號 1)Y軸皮帶固定座(圖4.2)，並使光軸固定座可以通過連結固定做鎖固於桌面，如圖4.3。\\


\begin{figure}[hbt!]
\begin{center}
\includegraphics[width=10cm]{axialseat}
\caption{Y軸皮帶固定座}
\end{center}
\end{figure}
...
\begin{figure}[hbt!]
\begin{center}
\includegraphics[width=10cm]{connectSeat}
\caption{連結固定座}
\end{center}
\end{figure}
