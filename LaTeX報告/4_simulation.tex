...
$$
h=\left\{\begin{matrix}0^{\circ}, & \textrm{if} max=min\\ 
...
60^{\circ}+\frac{g-b}{max-min}+240^{\circ}, & \textrm{if} max=b\end{matrix}\right.$$

$$s=\left\{\begin{matrix}0, & \textrm{if} ,max=0\\ 
\frac{max-min}{max}=1-\frac{min}{max}, & \textrm{otherwise}\end{matrix}\right.$$
...
(C,X,0)& ,0^{\circ}\leq H< 60^{\circ}\\ 
 ...
 (C,0,X)& ,300^{\circ}\leq H< 360^{\circ}\end{matrix}\right.$$
