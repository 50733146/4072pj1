...
\begin{figure}[hbt!]
\begin{center}
\includegraphics[width=12cm]{pong_pymunk}
\caption{\Large Pymunk模組編寫}
\label{fig.pong_pymunk}
\end{center}
\end{figure}
\newpage %圖片空隙勿刪
...
在單局結束時，紀錄下該局累積下來的經驗，亦是紀錄該局所修正出來的參數而進行獎勵計算、log probability、RMSprop優化率減因子
\newpage
\chapter{問題與討論}
