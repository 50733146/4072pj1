...
\begin{figure}[hbt!]
\begin{center}
\includegraphics[width=5cm]{origin}
...
\end{figure}
 \begin{figure}[hbt!]
\begin{center}
\includegraphics[width=5cm]{pong_gym}
...
\begin{figure}[hbt!]
\begin{center}
\includegraphics[width=10cm]{Q_ffmpeg-4}
...
\begin{figure}[hbt!]
\begin{center}
\includegraphics[width=10cm]{Q_ffmpeg-5}
...
\end{center}
\end{figure}
A：修改gym.wrappers.Monitor的video\_ recorder.py的設定(圖.\ref{fig.video_recorder})，將303行的縮排修正(從if階層上移到def的階層)即可(圖.)。\\
\begin{figure}[hbt!]
\begin{center}
