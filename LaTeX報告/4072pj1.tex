...
\newpage
%=---------------附錄-----------------=%
\addcontentsline{toc}{chapter}{\bibname} %新增目錄名稱
%\renewcommand{\bibname}{TTTTTT}
\titleformat{\chapter}[display]{\normalfont\LARGE\bfseries\makebox[3.5em][l]}{附~錄~}{1em}{\Large}[]
%\titlecontents{chapter}[11mm]{}{\sectionef\fontsize{18pt}{2.5pt}\bfseries\makebox[3.5em][l]
%\titleformat{\subsection}[hang]{\sectionef\fontsize{18pt}{2.5pt}\bfseries}{{\thesubsection}}{1em}{}[]
\renewcommand\appendixname{\makebox[3.5em][l] {附~錄}} %設定標題名稱
\begin{appendix}
\renewcommand{\thechapter}{\Alph{chapter}\bf 附錄}%設定標題名稱
\section{T}
\end{appendix}
\newpage
%=-------------作者簡介-----------------=%也是抄的
