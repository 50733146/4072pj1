...
\subcaptionbox{實體的冰球機\label{fig.冰球機}}{\includegraphics[width=4cm]{冰球機}}\quad
\subcaptionbox{虛擬環境簡化後的冰球機\label{fig.模擬冰球機}}{\includegraphics[width=4cm]{origin}}\quad
\subcaptionbox{Gym的Pong game\label{fig.pong_gym}}{\includegraphics[width=4cm]{pong_gym}}
