...
pong1r, pong1s = ".\pong1\history\e-4\pong1_rlist.txt", ".\pong1\history\e-4\pong1_Srlist.txt"

pong1_1r, pong1_1s = ".\pong1.1\pong1.1_rlist.txt", ".\pong1.1\pong1.1_Srlist.txt"
pong1_2r, pong1_2s = ".\pong1.2\history\e-3\pong1.2_rlist.txt", ".\pong1.2\history\e-3\pong1.2_Srlist.txt"
...
ax.plot(p1_2rd, ",",  label = "pong1.2", color = "darkorange")
ax.plot(p1_2sd, "darkorange", label = "pong1.2 MSE")
...
ax.legend(loc = 2)
plt.grid()
fig.savefig('pong_test.png', dpi=100)
