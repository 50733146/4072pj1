...
with cp.cuda.Device(0):
    if resume:
        ...
        reward_list = np.loadtxt("reward_list.txt")
        sum_reward_list = np.loadtxt("sum_reward_list.txt")
...
while True:
    ...
    if done: # an episode finished
        ...
        if episode_number % 100 == 0: np.savetxt("reward_list.txt", reward_list, fmt="%s")
        if episode_number % 100 == 0: np.savetxt("sum_reward_list.txt", sum_reward_list, fmt="%s")
        reward_sum = 0
